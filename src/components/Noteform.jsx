    ...
    return (
        <div className='text-black w-full relative'>
            <form action="" className='space-y-1 flex flex-col items-center justify-center' >
                ...
                <input maxLength={20} type="text" name='tagLine' required placeholder='Your tagline' onChange={handleInputChange} value={formData.tagLine || ''} className='border-b-[1px] w-full px-2 py-2 mt-5 border-black placeholder:text-black placeholder:font-light placeholder:text-base focus:outline-none text-sm font-normal' />
                ...
                {saving && <p className="text-xs absolute left-5 bottom-1 -translate-x-1/2 -translate-y-0 text-gray-500">saving...</p>}
            </form>
        </div>
    )
}
